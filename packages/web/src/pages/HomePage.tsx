    ...
    <Layout>
      <div className="mx-auto max-w-xl">
        <div className="mb-8 text-center">
          <span className="mb-3 inline-block rounded-full bg-indigo-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-indigo-600">
            AI-Ready
          </span>
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900">llms.txt Generator</h1>
          <p className="mt-2 text-slate-500">
            Crawl any website and generate a structured{' '}
            <a
        ...
        <form onSubmit={handleSubmit} className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          {showOptions && (
            <div className="mt-3 grid grid-cols-2 gap-4">
              <div>
                <label className="mb-1 block text-xs font-semibold text-slate-600">Max depth</label>
                <input
                  type="number"
                  value={maxDepth}
              ...
              <div>
                <label className="mb-1 block text-xs font-semibold text-slate-600">Max pages</label>
                <input
                  type="number"
                  value={maxPages}
