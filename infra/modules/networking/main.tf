...
resource "aws_security_group" "db" {
  ...
  ingress { from_port = 5432; to_port = 5432; protocol = "tcp"; security_groups = [aws_security_group.ecs.id, aws_security_group.lambda.id] }
}
...
resource "aws_security_group" "redis" {
  ...
  ingress { from_port = 6379; to_port = 6379; protocol = "tcp"; security_groups = [aws_security_group.ecs.id, aws_security_group.lambda.id] }
}
